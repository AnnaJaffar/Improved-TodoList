...
import logo from '../assets/ibisim190424.png';

const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white py-12 max-w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm">Experience the thrill of karting from where ever you are!</p>
          </div>
          <nav className="space-y-4">
            <h3 className="text-lg font-semibold mb-2">Quick Links</h3>
            <ul className="space-y-2 text-lg font-thin ">
        ...
        {/* <div className="mt-8 pt-8 border-t border-gray-700 text-center">
          <p>&copy; 2024 IbisimKart. All rights reserved.</p>
        </div> */}
      </div>
    </footer>
  );
